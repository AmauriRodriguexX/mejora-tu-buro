...
<footer class="site-footer border-t" style="border-color:var(--border)">
  <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
    <div class="mt-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_1.3fr]">
      ...
      <div id="aviso-privacidad"><h2 class="text-sm font-extrabold">Explora</h2><div class="mt-4 grid gap-2 text-sm"><a class="muted footer-link" href="#blog">Blog</a><a class="muted footer-link" href="#opiniones">Opiniones</a><a class="muted footer-link" href="#faq">Preguntas frecuentes</a></div></div>
