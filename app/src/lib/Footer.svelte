...
<footer class="site-footer border-t" style="border-color:var(--border)">
  <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
    <div class="mt-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1.3fr]">
      ...
      <div id="aviso-privacidad"><h2 class="text-sm font-extrabold">Legales</h2><div class="mt-4 grid gap-2 text-sm"><a class="muted footer-link" href="https://mejoraburo.com.mx/aviso-de-privacidad/" target="_blank" rel="noreferrer">Aviso de privacidad</a><a class="muted footer-link" href="https://mejoraburo.com.mx/terminos-y-condiciones/" target="_blank" rel="noreferrer">Términos y condiciones</a><a class="muted footer-link" href="#faq">Preguntas frecuentes</a></div></div>
    ...
    <div class="mt-10 border-t pt-5 text-xs muted" style="border-color:var(--border)"><p>© 2025 Mejora Buró Asesoría Legal y Financiera. Todos los derechos reservados por Baui Solutions S.A. de C.V.</p></div>
  </div>
</footer>
